    ...
    <div class="my-10 max-md:p-1 bg-blue-400 w-6/12 max-md:w-11/12 m-auto p-5 rounded-lg dark:bg-zinc-800">
      <ul class="grid grid-cols-2 gap-2 text-center text-white">
        <li class="m-4 max-md:m-2">
          <h3 class="font-semibold">Gestion de projets</h3>
          <p>Site vitrine, événement, e-commerce, site d'entreprise</p>
        </li>
        <li class="m-4 max-md:m-2">
        ...
        <li class="m-4 max-md:m-2">
          ...
          <p>Maquette de site web, logo, newsletters</p>
        </li>
        <li class="m-4 max-md:m-2">
        ...
        <li class="m-4 max-md:m-2">
          ...
          <p>Outils spécifiques au bon fonctionnemt de votre entreprise</p>
        </li>
        <li class="m-4 max-md:m-2">
